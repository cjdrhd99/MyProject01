...
const sec3ItemBox4 = sec3ItemBox[3];
const sec3ItemBox5 = sec3ItemBox[4];
const sec3ItemBox6 = sec3ItemBox[5];

console.log(sec3ItemBox4);
console.log(sec3ItemBox5);
console.log(sec3ItemBox6);

if(window.innerWidth <= 1024){
    sec3ItemBox4.setAttribute("data-aos-delay", "50");
    sec3ItemBox5.setAttribute("data-aos-delay", "100");
    sec3ItemBox6.setAttribute("data-aos-delay", "150");
}
